...
namespace XO
{
  public partial class Form1 : Form
  {
    ...
    private void setWinBtns(int x, int y, int l)
    {
      ...
      {
        case 0:
          b[0, y].BackColor = Color.Orange;
          b[1, y].BackColor = Color.Orange;
          b[2, y].BackColor = Color.Orange;
          break;
        case 1:
          b[x, 0].BackColor = Color.Orange;
          b[x, 1].BackColor = Color.Orange;
          b[x, 2].BackColor = Color.Orange;
          break;
        case 2:
          b[0, 0].BackColor = Color.Orange;
          b[1, 1].BackColor = Color.Orange;
          b[2, 2].BackColor = Color.Orange;
          break;
        case 3:
          b[2, 0].BackColor = Color.Orange;
          b[1, 1].BackColor = Color.Orange;
          b[0, 2].BackColor = Color.Orange;
          break;
      }
    }
